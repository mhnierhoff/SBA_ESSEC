...
customers_2015$segment[which(customers_2015$segment == "active" & customers_2015$first_purchase 
                             <= 365 & customers_2015$amount < 100)] = "new active low value"
customers_2015$segment[which(customers_2015$segment == "active" & customers_2015$first_purchase 
                             <= 365 & customers_2015$amount >= 100)] = "new active high value"
...
customers_2015$segment = factor(x = customers_2015$segment, levels = c("inactive", "cold",
                                                             ...
                                                             "new active low value", "new active high value"))
table(customers_2015$segment)
aggregate(x = customers_2015[, 2:5], by = list(customers_2015$segment), mean)
...
customers_2014$segment[which(customers_2014$segment == "active" & customers_2014$first_purchase 
                             <= 365 & customers_2014$amount < 100)] = "new active low value"
customers_2014$segment[which(customers_2014$segment == "active" & customers_2014$first_purchase 
                             <= 365 & customers_2014$amount >= 100)] = "new active high value"
...
##### 1st Q
table(customers_2015$segment == "new active low value")

##### 2nd Q
new_active_high_2015 <- table(customers_2015$segment == "new active high value")
new_active_high_2014 <- table(customers_2014$segment == "new active high value")

new_active_high_increase <- ((new_active_high_2015[2] - new_active_high_2014[2]) / 
                                     new_active_high_2014[2]) * 100

new_active_high_increase
...
avg_amount_new_active_high <- aggregate(x = customers_2015[, 2:5], by = list(customers_2015$segment), mean)

avg_amount_new_active_high <- avg_amount_new_active_high[9,]

avg_amount_new_active_high <- avg_amount_new_active_high$amount

avg_amount_new_active_high
