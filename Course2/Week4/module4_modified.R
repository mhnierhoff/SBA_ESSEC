...
# --- 1st Q ---------------------
firstQ <- segments[1,11]
firstQ

# --- 2nd Q ---------------------
secondQ <- disc_cumulated_revenue[11] - yearly_revenue[1]
secondQ

# --- 3rd Q ---------------------
thirdQ <- round(transition, digits = 3)
thirdQ <- thirdQ[5,2]
thirdQ
...
# --- 5th Q ---------------------
fifthQ <- segments[, 8]
fifthQ <- as.data.frame(fifthQ)
fifthQ <- colSums(fifthQ)
fifthQ