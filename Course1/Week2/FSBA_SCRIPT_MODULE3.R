...
data=read.table('Week2/DATA_3.01_CREDIT.csv',sep=',',header=TRUE) # The function read.table enables us to read flat files such as .csv files
...
datatot=read.table('Week2/DATA_3.02_HR2.csv', header = T,sep=',')
