...
dataold=read.table('Week3/DATA_3.01_CREDIT.csv',sep=',',header=TRUE) # The function read.table enables us to read flat files such as .csv files
datanew=read.table('Week3/DATA_4.01_CREDIT2.csv',sep=',',header=TRUE) # The function read.table enables us to read flat files such as .csv files
...
dataold=read.table('Week3/DATA_3.02_HR2.csv', header = T,sep=',') # The function read.table enables us to read flat files such as .csv files
datanew=read.table('Week3/DATA_4.02_HR3.csv', header = T,sep=',') # The new dataset on which we want to make the prediction
...
# Let's load the data
data=read.table('Week3/DATA_4.03_MNT.csv',sep=',',header=TRUE)
...
# Let's load our dataset and call it data
data=read.table('Week3/DATA_4.04_CHOC.csv',sep=',',header=TRUE) # The function read.table enables us to read flat files such as .csv files
